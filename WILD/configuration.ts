...
const CONFIGURATION: Configuration = {
	...
	information: {
		homePage: [
			{
				...
				description:
					content.HOME_PAGE.Information_Description_Historic_Mansion,
			},
			{
				title: content.HOME_PAGE.Information_Title_Elegant_Rooms,
				description:
					content.HOME_PAGE.Information_Description_Elegant_Rooms,
			},
			{
				title: content.HOME_PAGE.Information_Title_Hospitality,
				description:
					content.HOME_PAGE.Information_Description_Hospitality,
			},
		],
		...
		policies: [
			...
			},
			{
				title: 'Room Keys',
				description:
					'Please be advised that keys not returned to the Innkeeper will incur a $100 charge.',
			},
			{
				title: 'Smoke Free',
				description:
					'We are a Smoke-Free property. Absolutely no smoking is permitted inside, and a minimum charge of $500.00 will incur if smoking in your room is detected.',
			},
			{
				title: 'Children',
				description:
					'Throughout the year, we welcome children twelve (12) years of age and older. During the winter season, we can make exceptions if arranged prior to the stay for younger children. If a reservation is made where a child under the age of twelve (12) is staying without prior arrangement, we reserve the right to cancel your reservation upon arrival.',
			},
			{
				title: 'Rescheduling Fees',
				description:
					'If a guest chooses to reschedule, we reserve the right to charge up to a $30 rescheduling fee per 3-night stay.',
			},
			{
				title: 'Gift Certificate Policy',
				description:
					'Gift certificates must be noted when making the reservation. No refunds will be made if the gift certificate is not entered at the time of booking. Gift certificates are not transferable and cannot be redeemed for cash. Any remaining amount can be used at a later date up to the expiration date.',
			},
			{
				title: 'Additional Fees',
				description:
					'If a guest causes a disturbance toward other guests or staff, there will be a $100 added charge. For guests that leave biohazardous materials/fluids in the room, there will be a $250 charge for specialized cleaning.',
			},
		],
	},
	...
	socialMedia: {
		...
		tripadvisor:
			'https://www.tripadvisor.com/Hotel_Review-g48562-d121722-Reviews-The_Brunswick_at_Saratoga-Saratoga_Springs_New_York.html',
	},
} as const
